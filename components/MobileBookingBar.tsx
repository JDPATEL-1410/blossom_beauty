      ...
      {visible && (
        <motion.div initial={{ y: 100 }} animate={{ y: 0 }} exit={{ y: 100 }} transition={{ type: 'spring', damping: 25, stiffness: 300 }}
          ...
          <div className="bg-cream/96 backdrop-blur-xl border-t border-primary/15 px-3 py-2 flex items-center gap-2 shadow-[0_-4px_24px_rgba(169,82,74,0.12)]">
            ...
            <a href="tel:4045931680" className="w-11 h-11 glass-rose flex items-center justify-center text-primary active:scale-[0.93] transition-transform flex-shrink-0" aria-label="Call">
