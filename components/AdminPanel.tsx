...
export default function AdminPanel({ onClose }: Props) {
  ...
  // Initialize browser-only state on mount
  useEffect(() => {
    setAuthed(sessionStorage.getItem('blossom_admin') === '1');
    setReminderCount(getReminderCount());
    setPendingCount(getPendingApptCount());
  }, []);
