...
const categories: Cat[] = [
  ...
  },
  {
    ...
    desc: 'Expert cuts, color & styling for your unique look.',
    services: [
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'Lash Enhancement', price: '$45+', revisit: '4–6 wks' },
    ],
  },
];
    ...
    <section id="services" className="relative py-12 sm:py-20 md:py-28 bg-white-warm overflow-hidden">
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}
          ...
          <p className="text-dark/40 max-w-md mx-auto text-[11px] sm:text-sm md:text-base">
            Every service crafted with expertise, delivered with care.
          </p>
        </motion.div>
                  ...
                  <motion.div key={svc.name}
                    ...
                    <div className="flex items-center gap-2 sm:gap-2.5 min-w-0 flex-1">
                      ...
                      <div className="min-w-0">
                        <span className="font-medium text-dark/65 text-[12px] sm:text-[13.5px] truncate block">{svc.name}</span>
                        {svc.revisit && (
