    ...
    <section id="testimonials" className="relative py-12 sm:py-20 md:py-28 bg-white-warm overflow-hidden">
      ...
      <div ref={ref} className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={inView ? { opacity: 1, scale: 1, y: 0 } : {}}
          ...
          <p className="text-dark/50 text-[12px] sm:text-[14px] leading-relaxed max-w-md mx-auto mb-5">
            We are a <span className="text-rose font-semibold">freshly opened</span> beauty salon and every client is precious to us.
          ...
          <div className="grid grid-cols-3 gap-3 mb-5">
            {[
              ...
              <div key={f.label} className="flex flex-col items-center gap-1">
                ...
                <span className="text-[8px] sm:text-[10px] text-dark/40 font-medium">{f.label}</span>
              </div>
            ))}
          </div>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.4 }}
          ...
          <div>
            ...
            <p className="text-[10px] sm:text-[12px] text-dark/45 leading-relaxed">
