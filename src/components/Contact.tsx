...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-12 sm:py-20 md:py-28 bg-white-warm overflow-hidden">
      ...
      <img src="/images/section-flowers.png" alt="" className="floral-corner bottom-0 right-0 w-28 sm:w-44 opacity-[0.05] rotate-180 -scale-y-100" />
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }} className="text-center mb-6 sm:mb-10">
          <span className="inline-flex items-center gap-1.5 bg-gradient-to-r from-blush/50 to-lavender-light/25 text-rose px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full text-[8px] sm:text-[10px] font-semibold tracking-wider mb-2 sm:mb-3 border border-accent/10">
            <FaLocationArrow className="text-[6px] sm:text-[8px]" /> FIND US
          </span>
          ...
          <p className="text-dark/40 max-w-sm mx-auto text-[11px] sm:text-sm">We'd love to welcome you to our studio.</p>
        </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6, delay: 0.1 }} className="space-y-2.5 sm:space-y-3">
            ...
            <div className="glass-strong rounded-xl sm:rounded-2xl p-3.5 sm:p-5 flex items-start gap-3 group hover:shadow-lg hover:shadow-rose/5 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-[10px] sm:text-xs text-dark/45 leading-relaxed">Unit 9, Bellemay Salon Studios<br />3387 Highway 5 Suite A<br />Douglasville, GA 30135</p>
                <a href="https://maps.google.com/?q=3387+Highway+5+Suite+A+Douglasville+GA+30135" target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-rose text-[10px] sm:text-xs font-semibold mt-1 hover:text-rose-dark transition-colors">
                  <FaDirections className="text-[8px]" /> Get Directions
                </a>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              {[
                ...
                <div key={c.title} className="glass rounded-xl p-3 sm:p-3.5 group hover:shadow-md transition-all duration-300">
                  ...
                  <a href={c.href} className="text-dark/40 text-[9px] sm:text-[11px] hover:text-rose transition-colors break-all leading-tight">{c.val}</a>
                </div>
              ))}
            </div>
            ...
            <div className="glass rounded-xl sm:rounded-2xl p-3.5 sm:p-5">
              <div className="flex items-center gap-2.5 mb-2.5 sm:mb-3">
                ...
                <div>
                  ...
                  <p className="text-[8px] text-emerald font-medium flex items-center gap-1 mt-0.5"><span className="w-1 h-1 rounded-full bg-emerald inline-block" /> Open Now</p>
                </div>
              </div>
              <div className="grid grid-cols-2 sm:grid-cols-1 gap-1 sm:gap-1.5">
                {hours.map(h => (
                  <div key={h.day} className="flex justify-between text-[10px] sm:text-xs items-center">
                    <span className="text-dark/45 font-medium">{h.day}</span>
                    <span className={`font-medium ${h.open ? 'text-dark/60' : 'text-rose text-[9px]'}`}>{h.time}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <a href="tel:4045931680" className="btn-glow bg-gradient-to-r from-rose to-rose-dark text-white py-2.5 rounded-full font-semibold text-[11px] sm:text-sm text-center shadow-md shadow-rose/12 flex items-center justify-center gap-1.5 min-h-[40px]">
                <FaPhone className="text-[8px] sm:text-[10px]" /> Call Now
              </a>
              <a href="https://maps.google.com/?q=3387+Highway+5+Suite+A+Douglasville+GA+30135" target="_blank" rel="noopener noreferrer"
                className="btn-rose-outline border border-accent/20 text-rose py-2.5 rounded-full font-semibold text-[11px] sm:text-sm text-center flex items-center justify-center gap-1.5 min-h-[40px]">
                <FaDirections className="text-[8px] sm:text-[10px]" /> Directions
              </a>
            </div>
